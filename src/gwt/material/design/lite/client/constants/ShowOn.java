...
public enum ShowOn implements CssType {
    LARGE_SCREEN_ONLY("mdl-layout--large-screen-only"),
    SMALL_SCREEN_ONLY("mdl-layout--small-screen-only");
    ...
    public static ShowOn fromStyleName(final String styleName) {
        return EnumHelper.fromStyleName(styleName, ShowOn.class, LARGE_SCREEN_ONLY);
    }
}
