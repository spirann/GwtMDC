 ...
 */
public class LabelTypeMixin<T extends UIObject & HasType<LabelType>>  extends AbstractMixin<T>
		implements HasType<LabelType> {

	private LabelType labelType;

	public LabelTypeMixin(final T widget) {
		super(widget);
	}
	...
	public void setType(LabelType labelType) {
		...
		uiObject.setStylePrimaryName(labelType.getCssName());
	}
