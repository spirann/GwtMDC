...
public class MaterialContent extends Div implements HasToolbarFixedAdjust{
	...
	protected ApplyStyleMixin<MaterialContent> toolbarFixedAdjustMixin = new ApplyStyleMixin<>(this, CssName.MDC_TOOLBAR_FIXED_ADJUST);
	...
	public void setToolbarFixedAdjust(boolean toolbarFixedAdjust) {
		toolbarFixedAdjustMixin.setApply(toolbarFixedAdjust);
	}

	@Override
	public boolean isToolbarFixedAdjust() {
		return toolbarFixedAdjustMixin.isApplied();
	}
}
