...
public enum Ripple implements CssType {
	...
	PRIMARY(CssName.MDC_RIPPLE_UPGRADED + " " + CssName.MDC_RIPPLE_SURFACE + " " + CssName.MDC_RIPPLE_SURFACE_PRIMARY),
	SECONDARY(CssName.MDC_RIPPLE_UPGRADED + " " + CssName.MDC_RIPPLE_SURFACE + " " + CssName.MDC_RIPPLE_SURFACE_SECONDARY),
	ON_PRIMARY(CssName.MDC_RIPPLE_SURFACE + " " + CssName.MDC_RIPPLE_SURFACE_ON_PRIMARY),
	ON_SECONDARY(CssName.MDC_RIPPLE_SURFACE + " " + CssName.MDC_RIPPLE_SURFACE_ON_SECONDARY),
