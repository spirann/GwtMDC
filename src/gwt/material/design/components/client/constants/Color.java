...
public enum Color implements CssType {
	...
	//
	MDC_THEME_TEXT_PRIMARY_ON_SECONDARY("var(" + ThemeAttribute.MDC_THEME_TEXT_PRIMARY_ON_SECONDARY + ")"),
	//
	MDC_THEME_TEXT_SECONDARY_ON_SECONDARY("var(" + ThemeAttribute.MDC_THEME_TEXT_SECONDARY_ON_SECONDARY + ")"),
	//
	MDC_THEME_TEXT_HINT_ON_SECONDARY("var(" + ThemeAttribute.MDC_THEME_TEXT_HINT_ON_SECONDARY + ")"),
	//
	MDC_THEME_TEXT_DISABLED_ON_SECONDARY("var(" + ThemeAttribute.MDC_THEME_TEXT_DISABLED_ON_SECONDARY + ")"),
	//
	MDC_THEME_TEXT_ICON_ON_SECONDARY("var(" + ThemeAttribute.MDC_THEME_TEXT_ICON_ON_SECONDARY + ")"),
	//
	...
	//
	MDC_THEME_TEXT_PRIMARY_ON_SURFACE("var(" + ThemeAttribute.MDC_THEME_TEXT_PRIMARY_ON_SURFACE + ")"),
	//
	MDC_THEME_TEXT_SECONDARY_ON_SURFACE("var(" + ThemeAttribute.MDC_THEME_TEXT_SECONDARY_ON_SURFACE + ")"),
	//
	MDC_THEME_TEXT_HINT_ON_SURFACE("var(" + ThemeAttribute.MDC_THEME_TEXT_HINT_ON_SURFACE + ")"),
	//
	MDC_THEME_TEXT_DISABLED_ON_SURFACE("var(" + ThemeAttribute.MDC_THEME_TEXT_DISABLED_ON_SURFACE + ")"),
	//
	MDC_THEME_TEXT_ICON_ON_SURFACE("var(" + ThemeAttribute.MDC_THEME_TEXT_ICON_ON_SURFACE + ")"),
	//
